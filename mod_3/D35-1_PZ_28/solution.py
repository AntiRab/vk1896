"""
    ...
    В дочернем классе SemiCircle, который наследуется от
    родительского класса Circle с методами:
...
реализуйте метод calculate_area, который считает половину площади круга.
 Желательно, чтобы это было сделано через переиспользование
 метода calculate_area родительского класса.
